--// Decompiled Code. 
  ...
  local Window = Rayfield:CreateWindow({
     ...
     LoadingSubtitle = "by Ulito",
     ConfigurationSaving = {
        Enabled = false,
        FolderName = ulito, -- Create a custom folder for your hub/game
        FileName = "Ulito"
     },
     Discord = {
        Enabled = true,
        Invite = "bDVqjKds34", -- The Discord invite code, do not include discord.gg/. E.g. discord.gg/ABCD would be ABCD
     ...
     KeySettings = {
        ...
        FileName = "keylist", -- It is recommended to use something unique as other scripts using Rayfield may overwrite your key file
        SaveKey = false, -- The user's key will be saved, but if you change the key, they will be unable to use your script
        GrabKeyFromSite = true, -- If this is true, set Key below to the RAW site you would like Rayfield to get the key from
        Key = {"xenq1097","https://raw.githubusercontent.com/Ulitooo/fivem/main/keylist.txt"} -- List of keys that will be accepted by the system, can be RAW file links (pastebin, github etc) or simple strings ("hello","key22")
     }
  })
  ...
  Rayfield:Notify({
     Title = "You executed the script UlitoHub V1",
     Content = "Welcome!",
     Duration = 5,
     Image = xal,
     Actions = {},
